        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-center'>
          ...
          <div className='text-center md:text-right'>
            <div className='flex justify-center md:justify-end gap-4'>
              ...
              <a href="https://linkedin.com/in/aditya-mallick-7836692b6" target="_blank" rel="noopener noreferrer"
                 className='text-gray-400 hover:text-purple-400 transition-all duration-300 transform hover:scale-110'>
                <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
              ...
              <a href="mailto:aditya.mallick.1512@gmail.com"
                 className='text-gray-400 hover:text-purple-400 transition-all duration-300 transform hover:scale-110'>
                <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                  <path d='M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h.883l9.48 7.093 9.48-7.093h.884c.904 0 1.636.732 1.636 1.636z'/>
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className='border-t border-gray-800 mt-8 pt-6 text-center'>
          <div className='flex flex-col sm:flex-row justify-between items-center gap-4'>
            <p className='text-gray-500 text-sm text-center'>
              © {currentYear} Aditya Mallick. All rights reserved.
            </p>
